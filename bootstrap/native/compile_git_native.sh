...
fail(){ printf '╭─ NATIVE GIT BUILD FAILED\n╰─ %s\n' "$*" >&2; exit 1; }; info(){ printf '• %s\n' "$*"; }; warn(){ printf '! %s\n' "$*" >&2; }
printf '╭─ NATIVE GIT BUILD\n╰─ Rebuilding the active Homebrew binary for this Apple CPU\n'
